...
}
{
    ...
    localStorage.BASEInt === undefined ?
        localStorage.BASEInt = parseFloat(document.getElementById("BaseInt").value)
        : document.getElementById("BaseInt").value = localStorage.BASEInt
    ...
    localStorage.Legion === undefined ?
        localStorage.Legion = parseInt(document.getElementById("LegionLvL").value)
        : document.getElementById("LegionLvL").value = localStorage.Legion

    localStorage.LegionP === undefined ?
        localStorage.LegionP = parseInt(document.getElementById("LegionP").value)
        : document.getElementById("LegionP").value = localStorage.LegionP

    localStorage.MasterSkull === undefined ?
        localStorage.MasterSkull = parseInt(document.getElementById("MasterSkull").value)
        : document.getElementById("MasterSkull").value = localStorage.MasterSkull
}
