...
function Calculate() {
    ...
    {// Additional Priority 7
        {//FB?
            if (HelmetID === "Frozen_Blaze") {
                HelmetSC.Strength *= (1 + Pets.BlazePetB);
                HelmetSC.Crit_Damage *= (1 + Pets.BlazePetB);
            }
            if (ChestPID === "Frozen_Blaze") {
                ChestPCS.Strength *= (1 + Pets.BlazePetB);
                ChestPCS.Crit_Damage *= (1 + Pets.BlazePetB);
            }
            if (LeggingsID === "Frozen_Blaze") {
                LegSC.Strength *= (1 + Pets.BlazePetB);
                LegSC.Crit_Damage *= (1 + Pets.BlazePetB);
            }
            if (BootsID === "Frozen_Blaze") {
                BootsSC.Strength *= (1 + Pets.BlazePetB);
                BootsSC.Crit_Damage *= (1 + Pets.BlazePetB);
            }
        }
        if (Universe === "Dungeon") {
    ...
    {// Dmg-DPS Priority 8
        {// DmgBase
            ...
            ofa = (5 + Weapons.Damage + SellectedArrowDmg) * (1 + (Stats.E.Strength + Bestiary) / 100) * (1 + Stats.E.Crit_Damage / 100) * (1 + Enchants + 5);
        }
        {// DmgMin
    ...
    {// Print Damage  Priority 9
        ...
        document.getElementById("Gear").innerHTML = (`
                       ...
                       CritDamage: ${HelmetSC.Crit_Damage.toFixed(2)}<br><br>

                       ChestPlate: <br>
                         Strength: ${ChestPCS.Strength.toFixed(2)}<br>        
                       CritDamage: ${ChestPCS.Crit_Damage.toFixed(2)}<br><br>

                         Leggings: <br>
                         Strength: ${LegSC.Strength.toFixed(2)}<br>        
                       CritDamage: ${LegSC.Crit_Damage.toFixed(2)}<br><br>

                            Boots: <br>
                         Strength: ${BootsSC.Strength.toFixed(2)}<br>        
                       CritDamage: ${BootsSC.Crit_Damage.toFixed(2)}
                `);
        document.getElementById("Equipment").innerHTML = (`
                    Equipment (1): <br>
                         Strength: ${Equip1SC.Strength.toFixed(2)}<br>        
                       CritDamage: ${Equip1SC.Crit_Damage.toFixed(2)}<br><br>

                    Equipment (2): <br>
                         Strength: ${Equip2SC.Strength.toFixed(2)}<br>        
                       CritDamage: ${Equip2SC.Crit_Damage.toFixed(2)}<br><br>

                    Equipment (3): <br>
                         Strength: ${Equip3SC.Strength.toFixed(2)}<br>        
                       CritDamage: ${Equip3SC.Crit_Damage.toFixed(2)}<br><br>

                    Equipment (4): <br>
                         Strength: ${Equip4SC.Strength.toFixed(2)}<br>        
                       CritDamage: ${Equip4SC.Crit_Damage.toFixed(2)}
                `);
    ...
    {// Print  Priority 9
        document.getElementById("Result").innerHTML = (`
                           DmgMin: ${parseFloat(Math.floor(DmgMin)).toFixed(0).toLocaleString('en-US')}
                           DmgMax: ${parseFloat(Math.floor(DmgMax)).toFixed(0).toLocaleString('en-US')}<br>
                           DPSMin: ${parseFloat(Math.floor(DPSMin)).toFixed(0).toLocaleString('en-US')}
                           DPSMax: ${parseFloat(Math.floor(DPSMax)).toFixed(0).toLocaleString('en-US')}
                  `);
    }
    {// Print Text Priority 10
        document.getElementById("Test Result").innerHTML = (`
        Test Result <br>
            DmgMin: ${parseFloat(Math.floor(DmgMin)).toFixed(0).toLocaleString('en-US')}<br>
            OFA: ${parseFloat(Math.floor(ofa)).toFixed(0).toLocaleString('en-US')}
   `);
    }
    output()
}
