...
function Calculate() {
    ...
    {// Additional Priority 7
        ...
        {//Gear+Base+Pets Stats
            Gears.Strength =
                ...
                TReforges[AccesoryReforgeName].Strength * MagicalPower + TReforges.Strength;
            ...
            Gears.Crit_Damage =
                ...
                TReforges[AccesoryReforgeName].Crit_Damage * MagicalPower + TReforges.Crit_Damage;
            ...
            Gears.Bonus_Attack_Speed =
                ...
                TReforges[AccesoryReforgeName].Bonus_Attack_Speed * MagicalPower + TReforges.Bonus_Attack_Speed;
    ...
    {// Print Damage  Priority 9
        ...
        document.getElementById("Stats").innerHTML = (`Start Last<br>
                      ...
                      Crit Damage: ${Stats.Crit_Damage.toFixed(2)}
                `);
    }
    {// Print  Priority 9
