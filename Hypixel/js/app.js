...
function output() {
    document.getElementById("rageoutput1").innerHTML = document.getElementById("Combatlvl").value;
    document.getElementById("rageoutput2").innerHTML = document.getElementById("Catacomblvl").value;
    document.getElementById("rageoutput3").innerHTML = document.getElementById("Classlvl").value;
    ...
    document.getElementById("ChestPlateStar").innerHTML = document.getElementById("ChestPlateStarRange").value;
    ...
    document.getElementById("Equipment1Star").innerHTML = document.getElementById("Equipment1StarRange").value;
    document.getElementById("Equipment2Star").innerHTML = document.getElementById("Equipment2StarRange").value;
    document.getElementById("Equipment3Star").innerHTML = document.getElementById("Equipment3StarRange").value;
    document.getElementById("Equipment4Star").innerHTML = document.getElementById("Equipment4StarRange").value;
}
function GetData() {
    {
        ...
        Combatlvl = parseFloat(document.getElementById("Combatlvl").value)
        Catacomblvl = parseFloat(document.getElementById("Catacomblvl").value)
        Classlvl = parseFloat(document.getElementById("Classlvl").value)

        Stats.BASE.Strength = parseFloat(document.getElementById("BASESTR").value)
        Bestiary = parseFloat(document.getElementById("Bestiary").value)
        ...
        ChestPID = document.getElementById("ChestPlate").value
        LeggingsID = document.getElementById("Leggings").value
        BootsID = document.getElementById("Boots").value
        Pet = document.getElementById("Pet").value
        Equipment1ID = document.getElementById("Equipment1").value
        Equipment2ID = document.getElementById("Equipment2").value
        Equipment3ID = document.getElementById("Equipment3").value
        Equipment4ID = document.getElementById("Equipment4").value
        ...
        //Chest Plate
        if (parseFloat(document.getElementById("ChestPlateStarRange").value) < 6)
            ChestPCS.Star = parseFloat(document.getElementById("ChestPlateStarRange").value)
        else {
            ChestPCS.Star = 5
            ChestPCS.MasterStar = parseFloat(document.getElementById("ChestPlateStarRange").value) - ChestPCS.Star
        }
        ChestPCS.Reforge = document.getElementById("ChestPlateReforge").value
        if (document.getElementById("ChestPlateRecomb").checked)
            ChestPCS.Recomb = 1
        else
            ChestPCS.Recomb = 0
        ...
        //Equipment (1)
        if (parseFloat(document.getElementById("Equipment1StarRange").value) < 6)
            Equip1SC.Star = parseFloat(document.getElementById("Equipment1StarRange").value)
        else {
            Equip1SC.Star = 5
            Equip1SC.MasterStar = parseFloat(document.getElementById("Equipment1StarRange").value) - Equip1SC.Star
        }
        Equip1SC.Reforge = document.getElementById("Equipment1Reforge").value
        if (document.getElementById("Equipment1Recomb").checked)
            Equip1SC.Recomb = 1
        else
            Equip1SC.Recomb = 0

        //Equipment (2)
        if (parseFloat(document.getElementById("Equipment2StarRange").value) < 6)
            Equip2SC.Star = parseFloat(document.getElementById("Equipment2StarRange").value)
        else {
            Equip2SC.Star = 5
            Equip2SC.MasterStar = parseFloat(document.getElementById("Equipment2StarRange").value) - Equip2SC.Star
        }
        Equip2SC.Reforge = document.getElementById("Equipment2Reforge").value
        if (document.getElementById("Equipment2Recomb").checked)
            Equip2SC.Recomb = 1
        else
            Equip2SC.Recomb = 0

        //Equipment (3)
        if (parseFloat(document.getElementById("Equipment3StarRange").value) < 6)
            Equip3SC.Star = parseFloat(document.getElementById("Equipment3StarRange").value)
        else {
            Equip3SC.Star = 5
            Equip3SC.MasterStar = parseFloat(document.getElementById("Equipment3StarRange").value) - Equip3SC.Star
        }
        Equip3SC.Reforge = document.getElementById("Equipment3Reforge").value
        if (document.getElementById("Equipment3Recomb").checked)
            Equip3SC.Recomb = 1
        else
            Equip3SC.Recomb = 0

        //Equipment (4)
        if (parseFloat(document.getElementById("Equipment4StarRange").value) < 6)
            Equip4SC.Star = parseFloat(document.getElementById("Equipment4StarRange").value)
        else {
            Equip4SC.Star = 5
            Equip4SC.MasterStar = parseFloat(document.getElementById("Equipment4StarRange").value) - Equip4SC.Star
        }
        Equip4SC.Reforge = document.getElementById("Equipment4Reforge").value
        if (document.getElementById("Equipment4Recomb").checked)
            Equip4SC.Recomb = 1
        else
            Equip4SC.Recomb = 0
...
function EditHTML() {
    if (Universe !== "Dungeon") {
        Class.disabled = true
        Classlvl.disabled = true
    } else {
        Class.disabled = false
        Classlvl.disabled = false
    }
    if (DamageType !== lock) {
        lock = DamageType
...
function Calculate() {
    ...
    {// Pets Priority 2
        ...
        if (Pets === "Frozen_Blaze" && Universe !== "Crimson")
    ...
    {// Dmg-DPS Priority 8
        if (DamageType !== "Ability") {
            ...
            {// DmgMin
                DmgMin += Souleather * (1 + Stats.Crit_Damage / 100);
            }
            {// DmgMax
                DmgMax *= (1 + Overload) + Souleather * (1 + Stats.Crit_Damage / 100);;
            }
            {// DPSMin
                DPSMin *= 2;
    ...
    DmgMin: ${Math.floor(DmgMin).toLocaleString('tr-TR')}<br>
      Test: ${Math.floor(DmgMin).toLocaleString('tr-TR')}<br>
   `);
    }
    output()
}
function StoreData() {
    ...
    localStorage.Universe = document.getElementById("Universe").value
    localStorage.Class = document.getElementById("Class").value

    localStorage.Combatlvl = parseInt(document.getElementById("Combatlvl").value)
    localStorage.Catacomblvl = parseInt(document.getElementById("Catacomblvl").value)
    localStorage.Classlvl = parseInt(document.getElementById("Classlvl").value)

    localStorage.BASESTR = parseFloat(document.getElementById("BASESTR").value)
    localStorage.Bestiary = parseInt(document.getElementById("Bestiary").value)
    ...
    localStorage.ChestPlate = document.getElementById("ChestPlate").value
    localStorage.ChestPlateStar = document.getElementById("ChestPlateStarRange").value
    localStorage.ChestPlateReforge = document.getElementById("ChestPlateReforge").value
    localStorage.ChestPlateRecomb = document.getElementById("ChestPlateRecomb").checked
    ...
    localStorage.Equipment1 = document.getElementById("Equipment1").value
    localStorage.Equipment1Star = document.getElementById("Equipment1StarRange").value
    localStorage.Equipment1Reforge = document.getElementById("Equipment1Reforge").value
    localStorage.Equipment1Recomb = document.getElementById("Equipment1Recomb").checked

    localStorage.Equipment2 = document.getElementById("Equipment2").value
    localStorage.Equipment2Star = document.getElementById("Equipment2StarRange").value
    localStorage.Equipment2Reforge = document.getElementById("Equipment2Reforge").value
    localStorage.Equipment2Recomb = document.getElementById("Equipment2Recomb").checked

    localStorage.Equipment3 = document.getElementById("Equipment3").value
    localStorage.Equipment3Star = document.getElementById("Equipment3StarRange").value
    localStorage.Equipment3Reforge = document.getElementById("Equipment3Reforge").value
    localStorage.Equipment3Recomb = document.getElementById("Equipment3Recomb").checked

    localStorage.Equipment4 = document.getElementById("Equipment4").value
    localStorage.Equipment4Star = document.getElementById("Equipment4StarRange").value
    localStorage.Equipment4Reforge = document.getElementById("Equipment4Reforge").value
    localStorage.Equipment4Recomb = document.getElementById("Equipment4Recomb").checked
}