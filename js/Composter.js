...
function display() {
    ...
    {//Print
        ...
        document.getElementById("output6S").innerHTML = `Seed`
        ...
        if (fo) { document.getElementById("output9").innerHTML = `lvl your fuel`; }
        else { document.getElementById("output9").innerHTML = `lvl your organic`; }
